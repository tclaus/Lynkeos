...
@interface ___PACKAGENAMEASIDENTIFIER___Parameter : NSObject <LynkeosProcessingParameter>
{
   @public
...
@interface ___PACKAGENAMEASIDENTIFIER___ : NSObject <LynkeosProcessing>
{
